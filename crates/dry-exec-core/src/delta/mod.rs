...
pub use memory::{clear_soft_dirty_bits, read_process_memory, AnonymousMemoryRegion, PAGE_SIZE};
...
impl DeltaCoordinator {
    ...
    pub fn compute_full_delta(
        ...
        // 1. Compute memory mutations via kernel pagemap scan
        ...
        // 2. Compute filesystem mutations via tmpfs snapshot comparison
